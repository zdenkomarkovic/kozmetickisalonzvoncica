      ...
      <Container className="grid items-center gap-12 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-5 text-base leading-relaxed text-ink/70 sm:text-lg">
            Beauty &amp; Spa Zvončica nalazi se na adresi {SITE_ADDRESS}. U našem
            salonu spajamo kozmetičke tretmane, negu noktiju i opuštajuće masaže,
            kako biste na jednom mestu pronašli sve što vam je potrebno za negu i
            trenutak predaha.
          </p>
